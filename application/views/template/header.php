    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
				...
				<ul class="treeview-menu" >	
					<li>
					  <a href="<?php echo base_url(); ?>Barang_masuk">
						<i class="glyphicon glyphicon-cloud-download"></i> <span>Barang Masuk</span>
					  </a>
					</li>
					<li>
					  <a href="<?php echo base_url(); ?>Persediaan_asset">
						<i class="glyphicon glyphicon-home"></i> <span>Persediaan Asset</span>
					  </a>
					</li>
				</ul>
		</li>
		...
		<li class="treeview active">
				...
				<ul class="treeview-menu">
					<li>
						<a href="<?= base_url(); ?>report/bm">
							<i class="glyphicon glyphicon-list-alt"></i> <span>Barang Masuk - Data
						</a>
					</li>
				</ul>
			</li>
